...
import type { City as CityData, Country, AdministrativeDivision } from "@/types/geography";
import { formatPopulation, formatNumber } from "@/lib/geography";

export default function City({ city, country, division }: { city: CityData; country: Country; division?: AdministrativeDivision }) {
